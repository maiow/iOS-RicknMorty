...
//  RicknMorty
//
//  Created by mivanovskaya on 22.10.2023.
//
...
/// Shows serach results (table or collection as needed)
...
extension RMSearchResultsView: UIScrollViewDelegate {
    ...
    private func handleCharacterOrEpisodePagination(scrollView: UIScrollView) {
        //TODO: Write generic pagination logic
        ...
        Timer.scheduledTimer(withTimeInterval: 0.2, repeats: false) { [weak self] t in
            ...
            if offset >= (totalContentHeight - totalScrollViewFixedHeight - 120) {
                viewModel.fetchAdditionalResults { [weak self] newResults in
                    ...
                    let originalCount = collectionViewCellViewModels.count
                    ...
                    collectionViewCellViewModels = newResults
